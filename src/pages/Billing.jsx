...
export default function Billing() {
  ...
  useEffect(() => {
    const loadData = async (isRefresh = false) => {
      try {
        ...
        const invoicesData = Array.isArray(invoicesResponse.data)
  ...
  const filteredInvoices = invoices.filter((inv) => {
    ...
    const invMonth =
      invDate &&
      `${invDate.getFullYear()}-${String(invDate.getMonth() + 1).padStart(
        2,
        '0'
      )}`;
    const matchesMonth =
      monthFilter === 'ALL' || (invMonth && invMonth === monthFilter);
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        >
          <div>
            ...
            <p style={{ color: '#666' }}>
              Monitor invoices and financial transactions
            </p>
            {lastUpdated && (
              <p
                style={{
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ padding: '1rem' }}>
                      ...
                      >
                        ID: {invoice.patientId || invoice.patient?.id}
                      </div>
                    </td>
                    <td
                      style={{
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background:
                        currentPage === pageNum ? '#667eea' : 'white',
                      color:
                        currentPage === pageNum
                          ? 'white'
                          : '#374151',
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  {selectedInvoice.patient?.firstName}{' '}
